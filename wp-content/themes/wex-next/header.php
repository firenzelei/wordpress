...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url');?>/css/1.css" />
    ...
    <style>
        * {cursor: url(/usr/themes/next/images/sb/default.cur),default; }
...
<?php
if(cs_get_option('seo_switcher')==true){
    include ('seo.php');
}
